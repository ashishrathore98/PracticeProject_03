...
namespace PracticeProject_03.Models
{
    public class StudentMarks
    {
        string connectionString = "data source=DESKTOP-OT2PTPM;initial catalog=School3;integrated security=True;MultipleActiveResultSets=True;";
